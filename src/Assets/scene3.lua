...
-- ds
grey_r = gr.reflective_material({0.15, 0.18, 0.25}, 0.1, 0.3)
blue_r = gr.reflective_material({0.25, 0.95, 0.95}, 0.8, 0)
...
darksamus:rotate('x', 20)
darksamus:translate(15, 7, 21)
...
rootnode:animate(0, 35, 'translate', {0, 0, -20}, 'linear')
samus_right_arm_joint:animate(6, 15, 'rotate', {-35, 0, 0}, 'ease')
samus_right_arm_joint:animate(6, 15, 'rotate', {0, -85, 0}, 'ease')
samus_right_elbow_joint:animate(6, 15, 'rotate', {-5, 0, 0}, 'ease')
samus_right_elbow_joint:animate(6, 15, 'rotate', {0, -17, 0}, 'ease')

right_arm_joint:animate(6, 20, 'rotate', {0, -70, 0}, 'ease-in')
right_arm_joint:animate(6, 20, 'rotate', {-54, 0, 0}, 'ease-in')
...
gr.render(rootnode, './Generated/final-scene3/',
--330, 135,
660, 270,
--2100, 900,
{0, 15, 75}, {0, 0, -1}, {0, 1, 0}, 
...
50, {0.3, 0.3, 0.3}, {blue_light_1, blue_light_2, blue_light_3, blue_light_4}, 40, 
--0.1
1
)